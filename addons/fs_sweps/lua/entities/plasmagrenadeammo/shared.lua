ENT.Type 			= "anim"
ENT.Base 			= "base_anim"
ENT.PrintName		= "Plasma Grenade Box"
...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("PlasmaGrenadeAmmo")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) and not self.Planted then
		if activator:GetWeapon("weapon_grenadeplasma") == NULL then
			activator:Give("weapon_grenadeplasma")
			activator:GiveAmmo(1, "PlasmaGrenade")
		else		
			activator:GiveAmmo(1, "PlasmaGrenade")
		end
		self.Entity:Remove()
