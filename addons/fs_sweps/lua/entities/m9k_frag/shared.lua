...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/halokiller38/fallout/weapons/mines/minefrag.mdl")
...
function ENT:Explosion()
	...
	util.BlastDamage(self.Entity, self.Owner, self.Entity:GetPos(), 400, 140	)
