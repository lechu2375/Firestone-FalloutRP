...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("m9k_ammo_fragmines")
...
function ENT:Initialize()
	...
	local model = ("models/Halokiller38/fallout/weapons/mines/minefrag.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) and not self.Planted then
		if activator:GetWeapon("weapon_minefrag") == NULL then
			activator:Give("weapon_minefrag")
			activator:GiveAmmo(1, "FragMine")
		else		
			activator:GiveAmmo(1, "FragMine")
		end
		self.Entity:Remove()
