...
SWEP.data.burst.Cone 		= .040	-- Cone of the buckshot rounds
SWEP.data.burst.NumShots 	= 15		-- 15 little leads
...
SWEP.data.semi.Damage 		= 55		-- Damage of the big lead
/*---------------------------------------------------------
SecondaryAttack
---------------------------------------------------------*/
...
-- 	bullet.Callback	= function ( a, b, c ) BulletPenetration( 0, a, b, c ) end 	-- CALL THE FUNCTION BULLETPENETRATION
	...
	if trace.Entity:GetClass() == "prop_door_rotating" and self.mode == "burst" and (SERVER) then
		...
		trace.Entity:TakeDamage(500, self.Owner,"")
