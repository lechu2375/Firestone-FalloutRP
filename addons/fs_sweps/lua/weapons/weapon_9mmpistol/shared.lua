...
local ActIndex = {}		
	...
	ActIndex["lepszypistol"]	= ACT_DOD_STAND_IDLE_PISTOL
...
local ActIndex = {
	...
	["lepszypistol"]    = ACT_DOD_STAND_IDLE_PISTOL
}
...
SWEP.ViewModel = "models/visualitygaming/fallout/weapons/v_9mm_pistol.mdl"
...
SWEP.EjectDelay			= "0"
/*-------------------------------------------------------*/
SWEP.IronSightsPos = Vector(1.72, 0, 1.639)
