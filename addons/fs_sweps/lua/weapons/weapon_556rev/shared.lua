...
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/halokiller38/fallout/weapons/pistols/556pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.029, 1.679, 1.427), angle = Angle(180, -90, 1), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.ViewModel = "models/visualitygaming/fallout/weapons/v_rev_556.mdl"
SWEP.WorldModel = "models/halokiller38/fallout/weapons/pistols/556pistol.mdl"
