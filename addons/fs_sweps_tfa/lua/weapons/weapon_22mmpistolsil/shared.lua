...
SWEP.PrintName              = "Pistolet wyciszony .22mm"       -- Weapon name (Shown on HUD)
SWEP.Slot               = 2             -- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos                = 73            -- Position in the slot
SWEP.AutoSwitchTo           = true      -- Auto switch to if we pick it up
SWEP.AutoSwitchFrom         = true      -- Auto switch from if you pick up a better weapon
SWEP.Weight             = 4            -- This controls how "good" the weapon is for autopickup.



--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/pistol_22mm/wpn_silenced_22_pistol.wav") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.KickDown = .07 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .01 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_9mm_22pistol.mdl" --Viewmodel path
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/pistols/silenced22pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.557, 1.557, 0), angle = Angle(0, 80, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
