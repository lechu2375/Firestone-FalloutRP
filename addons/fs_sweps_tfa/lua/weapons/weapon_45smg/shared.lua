...
SWEP.PrintName              = "Pistolet maszynowy .45"       -- Weapon name (Shown on HUD)
SWEP.Slot               = 2             -- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos                = 73            -- Position in the slot
SWEP.AutoSwitchTo           = true      -- Auto switch to if we pick it up
SWEP.AutoSwitchFrom         = true      -- Auto switch from if you pick up a better weapon
SWEP.Weight             = 27            -- This controls how "good" the weapon is for autopickup.



--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/45smg/wpn_45smg.wav") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp = .33 -- This is the maximum upwards recoil (rise)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_smg_45.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 34        -- This controls how big the viewmodel looks.  Less is more.
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/smgs/45smg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.557, 0.518, 0), angle = Angle(0, 80, -171.818), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
