...
SWEP.PrintName              = "Chiński pistolet ludowy"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/pistolchinese/wpn_chinesepistol.wav") -- This is the sound of the weapon, when you shoot.
...
SWEP.JamFactor = 0.15 -- How to increase jam factor after each shot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_9mm_chinesepistol.mdl" --Viewmodel path
