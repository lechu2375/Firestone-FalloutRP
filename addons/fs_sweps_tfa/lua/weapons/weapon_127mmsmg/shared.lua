...
SWEP.PrintName              = "Pistolet maszynowy 12.7mm"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/22smgsil/wpn_127smg.wav") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_smg_127.mdl" --Viewmodel path
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.3, ["type"] = "sound", ["value"] = Sound("weapons/22smgsil/weapon_127mm_reload.wav") }
  }
}
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/smgs/127smg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.636, 0, 0.518), angle = Angle(1.169, 85.324, 180), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
