...
SWEP.PrintName              = "Revolver .357"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM = 190 -- This is in Rounds Per Minute / RPM
...
--Firing Cone Related
SWEP.Primary.Spread = .067 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rev_357.mdl" --Viewmodel path
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapons/357revolver/wpn_357revolver_reload.wav") }
  }
}
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/pistols/357revolvershorthdcyl.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.519, 1.557, 1.557), angle = Angle(0, 90, -180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
