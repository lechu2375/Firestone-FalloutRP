...
SWEP.PrintName              = "Karabin R91"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.KickHorizontal = .11 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rifle_r91.mdl" --Viewmodel path
...
SWEP.ProceduralReloadTime = 2 --Procedural reload time?
--[[HOLDTYPES]]--
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/assaultrifles/r91assaultrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.597, 0.518, 1.557), angle = Angle(0, 90, -178.831), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
