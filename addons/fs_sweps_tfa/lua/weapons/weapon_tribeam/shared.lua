...
SWEP.PrintName              = "Trójstrzałowiec Laserowy"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/laserrifle/wpn_lasertribeam_fire_2d_0"..math.random(1,2)..".wav") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 4.5 -- Damage, in standard damage points.
...
--Recoil Related
SWEP.Primary.KickUp = .6 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = .4 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .17 -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor = .8 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/weapons/v_laserrifle.mdl" --Viewmodel path
...
--Impact Effects
SWEP.ImpactEffect = "effect_fo3_hit"--Impact Effect
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapons/laserrifle/wpn_riflelaser_reloadinout.wav") }
  }
}
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/tribeamlaserrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, -0.519, 2.596), angle = Angle(0, 90, -178.831), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.VElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/tribeamlaserrifle.mdl", bone = "ValveBiped.Bip01_Weapon_Bone", rel = "", pos = Vector(0, -8.832, -3.636), angle = Angle(0, 180, 5.843), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
