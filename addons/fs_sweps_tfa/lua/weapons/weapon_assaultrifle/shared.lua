...
SWEP.PrintName              = "Karabin szturmowy"       -- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rifle_carbine.mdl" --Viewmodel path
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.8, ["type"] = "sound", ["value"] = Sound("weapons/lightmachinegun/wpn_lightmachgun_reload.wav") }
  }
}
...
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/halokiller38/fallout/weapons/assaultrifles/assaultcarbine.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.448, 0.777, 2.404), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
