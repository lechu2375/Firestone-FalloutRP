...
SWEP.PrintName              = "Trail carbine"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Shotgun = true
SWEP.Primary.Sound = Sound("weapons/rifletrailcarbine/wpn_trailcarbine.wav") -- This is the sound of the weapon, when you shoot.
...
SWEP.JamChance = 0.08 -- the (maximal) chance the weapon will jam. Newly spawned weapon will never jam on first shot for example.
...
SWEP.Primary.StaticRecoilFactor = 2.5 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rifle_trailcarbine.mdl" --Viewmodel path
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapons/shotgunsingle/wpn_shotgunsingle_reload.wav") }
  }
}
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/trailcarbine.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.558, 1.557, 0.518), angle = Angle(0, 92.337, -180), size = Vector(1.149, 1.149, 1.149), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
