...
SWEP.PrintName              = "Karabin wyborowy"       -- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rifle_mcarbine.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-7.441, 0, 1.519)
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/assaultrifles/marksmancarbine.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 1.2, 0.518), angle = Angle(0, 90, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
