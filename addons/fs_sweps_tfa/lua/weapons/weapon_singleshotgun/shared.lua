...
SWEP.Category               = "TFA Firestone" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName              = "Pojedyńcza strzelba"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Shotgun = true
SWEP.Primary.Sound = Sound("weapons/shotgunsingle/wpn_singleshotgun_fire.wav") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = nil -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = .8 --Change the amount of something this gun can penetrate through
...
SWEP.JamChance = 0.20 -- the (maximal) chance the weapon will jam. Newly spawned weapon will never jam on first shot for example.
...
SWEP.JamFactor = 0.09 -- How to increase jam factor after each shot.
...
SWEP.FireModeName = "Semi" --Change to a text value to override it
...
SWEP.Primary.KickDown = .27 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .12 -- This is the maximum sideways recoil (no real term)
...
SWEP.Primary.IronAccuracy = .032 -- Ironsight accuracy, should be the same for shotguns
--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
SWEP.Primary.SpreadMultiplierMax = .04--How far the spread can expand when you shoot. Example val: 2.5
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rifle_scattergun.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 37        -- This controls how big the viewmodel looks.  Less is more.
...
SWEP.IronSightsPos = Vector(1.72, 0, 1)
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      { ["time"] = 0.01, ["type"] = "lua", ["value"] = function( wep, viewmodel ) end, ["client"] = true, ["server"] = true},
      { ["time"] = 0.01, ["type"] = "sound", ["value"] = Sound("weapons/shotgunsingle/wpn_shotgunsingle_reload.wav") }
  }
}
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/scattergun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.676, 0.518, 2.596), angle = Angle(0, 90, -174.157), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
