...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/rifleassaultsilenced/wpn_rifleassaultsilenced.wav") -- This is the sound of the weapon, when you shoot.
...
SWEP.FireModeName = "Full auto" --Change to a text value to override it
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rifle_infil.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 29        -- This controls how big the viewmodel looks.  Less is more.
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapon_127mmsmg_reload.ogg") },
			{ ["time"] = 1, ["type"] = "sound", ["value"] = Sound("weapons/riflemarksmancarbine/wpn_markscarb_reload.wav") },
			{ ["time"] = 2.7, ["type"] = "sound", ["value"] = Sound("weapon_127mmsmg_reload.ogg") }
  },
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/assaultrifles/infiltrator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.519, 0.518, 2.596), angle = Angle(-1.17, 87.662, -164.805), size = Vector(1, 1.1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
