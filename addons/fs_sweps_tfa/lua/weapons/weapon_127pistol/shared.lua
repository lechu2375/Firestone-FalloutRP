...
SWEP.PrintName              = "Pistolet 12.7mm"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/pistol_127/wep_127.wav") -- This is the sound of the weapon, when you shoot.
...
--Recoil Related
SWEP.Primary.KickUp = .20 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = .16 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .04 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_127mm_pistol.mdl" --Viewmodel path
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/pistols/127mmpistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.557, 1.557, 0), angle = Angle(0, 80, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
