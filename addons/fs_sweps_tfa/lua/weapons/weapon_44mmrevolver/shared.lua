...
SWEP.PrintName              = "Revolver .44"       -- Weapon name (Shown on HUD)
SWEP.Slot               = 2             -- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos                = 73            -- Position in the slot
SWEP.AutoSwitchTo           = true      -- Auto switch to if we pick it up
SWEP.AutoSwitchFrom         = true      -- Auto switch from if you pick up a better weapon
SWEP.Weight             = 6            -- This controls how "good" the weapon is for autopickup.



--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/pistol44magnum/wpn_44revolver.wav") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.StaticRecoilFactor = 3.4 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rev_44.mdl" --Viewmodel path
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      { ["time"] = 0.1, ["type"] = "lua", ["value"] = function( wep, viewmodel ) end, ["client"] = true, ["server"] = true},
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapons/pistol44magnum/wpn_44revolver_reload.wav") }
  }
}
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/pistols/44revolverunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.519, 1.557, 1.557), angle = Angle(0, 90, -180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
