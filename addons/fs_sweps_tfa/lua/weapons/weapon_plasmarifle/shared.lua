...
SWEP.PrintName              = "Karabin plazmowy"       -- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("weapons/plasmarifle/wpn_rifleplasma.wav") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM_Semi = 140 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.VElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/plasma weapons/plasmarifle.mdl", bone = "ValveBiped.Bip01_Weapon_Bone", rel = "", pos = Vector(-0.519, -3.636, 1.557), angle = Angle(0, 180, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
