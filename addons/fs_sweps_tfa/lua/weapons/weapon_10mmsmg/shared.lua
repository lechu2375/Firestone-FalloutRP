...
SWEP.PrintName              = "Pistolet maszynowy 10mm"       -- Weapon name (Shown on HUD)
SWEP.Slot               = 2             -- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos                = 73            -- Position in the slot
SWEP.AutoSwitchTo           = true      -- Auto switch to if we pick it up
SWEP.AutoSwitchFrom         = true      -- Auto switch from if you pick up a better weapon
SWEP.Weight             = 33            -- This controls how "good" the weapon is for autopickup.
...
SWEP.Primary.RPM = 610 -- This is in Rounds Per Minute / RPM
...
SWEP.DefaultFireMode = "Automatyczny" --Default to auto or whatev
SWEP.FireModeName = "Automatyczny" --Change to a text value to override it
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_smg_10.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 47        -- This controls how big the viewmodel looks.  Less is more.
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapons/9mm_smg/wpn_9mm_reload.wav") }
  }
}
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/smgs/10mmsmg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.518, 0.518, 0.518), angle = Angle(180, -90, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
