...
SWEP.PrintName              = "Karabin plazmowy pompa"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.AmmoConsumption = 6 --Ammo consumed per shot
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/plasma weapons/multiplasrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 0, -6.753), angle = Angle(0, 90, -180), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.VElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/plasma weapons/multiplasrifle.mdl", bone = "ValveBiped.Bip01_Weapon_Bone", rel = "", pos = Vector(-1.558, -2.597, 7.791), angle = Angle(0, 180, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
