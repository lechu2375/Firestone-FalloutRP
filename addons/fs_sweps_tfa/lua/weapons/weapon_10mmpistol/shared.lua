...
SWEP.PrintName              = "Pistolet 10mm"       -- Weapon name (Shown on HUD)
SWEP.Slot               = 2             -- Slot in the weapon selection menu.  Subtract 1, as this starts at 0.
SWEP.SlotPos                = 73            -- Position in the slot
SWEP.AutoSwitchTo           = true      -- Auto switch to if we pick it up
SWEP.AutoSwitchFrom         = true      -- Auto switch from if you pick up a better weapon
SWEP.Weight             = 7            -- This controls how "good" the weapon is for autopickup.
...
SWEP.JamFactor = 0.11 -- How to increase jam factor after each shot.
...
--Recoil Related
SWEP.Primary.KickUp = .16 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = .08 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .02 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_10mm_pistol.mdl" --Viewmodel path
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapons/pistol_10mm/wpn_pistol10mm_reload.wav") }
  }
}
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/pistols/10mmpistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.557, 1.557, 0), angle = Angle(0, 80, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
