...
SWEP.PrintName              = "Pistolet maszynowy 9mm"       -- Weapon name (Shown on HUD)
...
SWEP.JamChance = 0.004 -- the (maximal) chance the weapon will jam. Newly spawned weapon will never jam on first shot for example.
...
SWEP.Primary.KickDown = .37 -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal = .15 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_9mm_smg.mdl" --Viewmodel path
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/smgs/9mmsmg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.518, 0.518, 0.518), angle = Angle(180, -90, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
