...
SWEP.PrintName              = "Karabin kowboja"       -- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM = 102 -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi = 102 -- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rifle_lever_cowboy_repeater.mdl" --Viewmodel path
