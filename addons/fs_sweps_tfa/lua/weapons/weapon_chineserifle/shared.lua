...
SWEP.PrintName              = "Chiński karabin szturmowy"       -- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/rifles/v_rifle_chinese.mdl" --Viewmodel path
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.8, ["type"] = "sound", ["value"] = Sound("weapons/lightmachinegun/weapon_chineseassault_reload.mp3") }
  }
}
