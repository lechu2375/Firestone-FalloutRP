...
--[[WEAPON HANDLING]]--
SWEP.Shotgun = true
SWEP.Primary.Sound = Sound("weapons/riflebrushgun/wpn_brushgun.wav") -- This is the sound of the weapon, when you shoot.
...
--Firing Cone Related
SWEP.Primary.Spread = .011 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_rifle_lever_brushgun.mdl" --Viewmodel path
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapons/combatshotgun/reload/reload2.wav") }
  },
  [ACT_SHOTGUN_RELOAD_FINISH] = {
      { ["time"] = 0.1, ["type"] = "lua", ["value"] = function( wep, viewmodel ) end, ["client"] = true, ["server"] = true},
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapons/combatshotgun/reload/reload3.wav") }
  }
}
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/rifles/brushgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 1.557, 1.557), angle = Angle(0, 90, -180), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.ViewModelBoneMods = {
	["wep.base"] = { scale = Vector(1.2, 1.2, 1.2), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
