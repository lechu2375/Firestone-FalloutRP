...
SWEP.PrintName              = "Laserowy SMG"       -- Weapon name (Shown on HUD)
...
SWEP.FireModeName = "Auto" --Change to a text value to override it
...
SWEP.Primary.KickHorizontal = .16 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/models/weapons/c_codww2_ppsh41.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 40        -- This controls how big the viewmodel looks.  Less is more.
...
SWEP.ImpactDecal = "none" --Impact Decal
--[[EVENT TABLE]]--
...
SWEP.EventTable = {
  [ACT_VM_RELOAD] = {
      ...
      { ["time"] = 0.1, ["type"] = "sound", ["value"] = Sound("weapons/laser_rcw/wpn_laserrcw_reload.wav") }
  }
}
...
SWEP.ViewModelBoneMods = {
	["j_gun"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
SWEP.VElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/laserpdw.mdl", bone = "j_gun", rel = "", pos = Vector(9.869, 1.557, -6), angle = Angle(0, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/energy weapons/laserrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, -0.519, 2.596), angle = Angle(0, 90, -178.831), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
