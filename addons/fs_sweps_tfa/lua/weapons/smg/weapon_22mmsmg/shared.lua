...
SWEP.PrintName              = "Wyciszony pistolet maszynowy .22"       -- Weapon name (Shown on HUD)
...
SWEP.JamChance = 0.02 -- the (maximal) chance the weapon will jam. Newly spawned weapon will never jam on first shot for example.
...
-- Weapon is a shotgun
--Ammo Related
SWEP.Primary.ClipSize = 180 -- This is the size of a clip
...
--Recoil Related
SWEP.Primary.KickUp = .22 -- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown = .17 -- This is the maximum downwards recoil (skeet)
...
--[[VIEWMODEL]]--
SWEP.ViewModel          = "models/visualitygaming/fallout/weapons/v_smg_22.mdl" --Viewmodel path
SWEP.ViewModelFOV           = 30        -- This controls how big the viewmodel looks.  Less is more.
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/smgs/22smgext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.519, 0.518, 1.557), angle = Angle(3.506, 80, -174.157), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
