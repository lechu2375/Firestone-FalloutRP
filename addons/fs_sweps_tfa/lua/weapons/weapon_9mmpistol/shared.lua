...
SWEP.PrintName              = "Pistolet 9mm"       -- Weapon name (Shown on HUD)
...
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/pistols/9mmpistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.557, 1.557, 0), angle = Angle(0, 80, 180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
