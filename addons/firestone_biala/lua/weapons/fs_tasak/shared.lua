...
if CLIENT then 
SWEP.VElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/cleaver.mdl", bone = "v_me_butcherknife", rel = "", pos = Vector(0, -2.597, -7.792), angle = Angle(0, -160, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
