...
SWEP.VElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/ballisticfist.mdl", bone = "SphereGizmo02", rel = "", pos = Vector(-2.597, -3.636, 0.518), angle = Angle(1.169, -90, -3.507), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["model"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/ballisticfist.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-0.519, -0.519, 1.557), angle = Angle(-17.532, -92.338, 10.519), size = Vector(1.399, 1.399, 1.399), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.ViewModelBoneMods = {
	["SphereGizmo02"] = { scale = Vector(0.481, 0.481, 0.481), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}



SWEP.PrintName = "Rękawica wspomagana"
