...
ConvarList["vj_npc_nogib"] = 1 -- Disable gibbing
...
ConvarList["vj_npc_nofollowplayer"] = 1 -- Disable SNPCs following players
...
ConvarList["vj_npc_nomedics"] = 1 -- Disables medic SNPCs
	-- ====== Creature Settings ====== --
...
ConvarList["vj_npc_bleedenemyonmelee"] = 1 -- Disable SNPCs bleeding their enemy on melee attack
ConvarList["vj_npc_noproppush"] = 0 -- Disable SNPCs pushing props
ConvarList["vj_npc_nopropattack"] = 1 -- Disable SNPCs attacking props
...
ConvarList["vj_npc_noforeverammo"] = 1 -- No unlimited ammo - Human
...
ConvarList["vj_npc_nothrowgrenade"] = 1 -- Disable humans SNPCs throwing grenades
	-- ====== Animal Settings ====== --
...
ConvarList["vj_npc_corpsefade"] = 1 -- Make Corpses fade
...
ConvarList["vj_npc_itemdrops"] = 0 -- item drops on death?
...
ConvarList["vj_npc_creatureopendoor"] = 1 -- Should Creatures open doors?
	-- ====== Human Options ====== --
ConvarList["vj_npc_dropweapon"] = 0 -- Drop Weapon on death?
ConvarList["vj_npc_plypickupdropwep"] = 0 -- Can players pick up dropped weapons?
ConvarList["vj_npc_accuracy_poor"] = 0 -- Accuracy = Poor
ConvarList["vj_npc_accuracy_average"] = 0 -- Accuracy = Average
ConvarList["vj_npc_accuracy_good"] = 1 -- Accuracy = Good
